...
INSERT INTO `cidade` (`cidCodigo`, `estCodigo`, `cidNome`) VALUES
	...
	(1506500, 15, 'Santa Isabel do Pará'),
...
-- Copiando estrutura para tabela vinicula.estado
CREATE TABLE IF NOT EXISTS `estado` (
  `estCodigo` int(11) NOT NULL AUTO_INCREMENT,
  `estSigla` varchar(2) DEFAULT NULL,
  `estNome` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`estCodigo`),
  UNIQUE KEY `estCodigo_UNIQUE` (`estCodigo`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela vinicula.estado: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `estado` DISABLE KEYS */;
INSERT INTO `estado` (`estCodigo`, `estSigla`, `estNome`) VALUES
	(11, 'RO', 'Rondônia'),
	(12, 'AC', 'Acre'),
	(13, 'AM', 'Amazonas'),
	(14, 'RR', 'Roraima'),
...
-- Copiando estrutura para tabela vinicula.perfil
...
-- Copiando estrutura para tabela vinicula.perfilxtela
CREATE TABLE IF NOT EXISTS `perfilxtela` (
  `pxtCodigo` int(11) NOT NULL AUTO_INCREMENT,
...
-- Copiando estrutura para tabela vinicula.pessoa
...
-- Copiando estrutura para tabela vinicula.pessoaxtipo
CREATE TABLE IF NOT EXISTS `pessoaxtipo` (
...
-- Copiando estrutura para tabela vinicula.produto
...
-- Copiando estrutura para tabela vinicula.produtoxorcamento
CREATE TABLE IF NOT EXISTS `produtoxorcamento` (
  `genCodigo` int(11) NOT NULL AUTO_INCREMENT,
  `orcCodigo` int(11) DEFAULT NULL,
  `proCodigo` int(11) DEFAULT NULL,
  `genValorUnitario` decimal(8,2) DEFAULT NULL,
  `genQuantidade` int(11) DEFAULT NULL,
...
-- Copiando estrutura para tabela vinicula.tipopessoa
CREATE TABLE IF NOT EXISTS `tipopessoa` (
  `tipCodigo` int(11) NOT NULL AUTO_INCREMENT,
  `tipSigla` char(2) DEFAULT NULL,
  `tipNome` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`tipCodigo`),
  UNIQUE KEY `tipCodigo_UNIQUE` (`tipCodigo`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela vinicula.tipopessoa: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `tipopessoa` DISABLE KEYS */;
INSERT INTO `tipopessoa` (`tipCodigo`, `tipSigla`, `tipNome`) VALUES
	(1, 'C', 'Cliente'),
	(2, 'Fi', 'Filial'),
	(3, 'F', 'Funcionário');
...
-- Copiando estrutura para tabela vinicula.usuario
CREATE TABLE IF NOT EXISTS `usuario` (
  `usuCodigo` int(11) NOT NULL AUTO_INCREMENT,
  `usuNome` varchar(20) DEFAULT NULL,
